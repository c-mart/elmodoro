...
var _user$project$Elmodoro$viewStatus = function (status) {
	...
	switch (_p1.ctor) {
		...
		case 'PomoOn':
			return _elm_lang$html$Html$text('You\'re working on:');
		case 'PomoPaused':
			return _elm_lang$html$Html$text('Work session paused');
		default:
...
var _user$project$Elmodoro$viewStats = function (model) {
	var pomos = {ctor: '::', _0: model.curPomo, _1: model.prevPomos};
	var totalTime = A3(
		_elm_lang$core$List$foldl,
		F2(
	...
	var completedPomos = function (x) {
		...
		_elm_lang$core$List$length(pomos));
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(
				A2(_elm_lang$core$Basics_ops['++'], 'Total time worked: ', totalTimeStr)),
			_1: {
				ctor: '::',
				_0: A2(
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html$text(
						A2(_elm_lang$core$Basics_ops['++'], 'Completed pomodoros: ', completedPomos)),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$Elmodoro$updateDesc = F2(
	function (model, newDesc) {
		...
		var newPomo = _elm_lang$core$Native_Utils.update(
			oldPomo,
			{desc: newDesc});
		return _elm_lang$core$Native_Utils.update(
			model,
			...
			return A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_user$project$Elmodoro$StartPomo),
							_1: {
								ctor: '::',
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Start Working'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				});
			...
			return A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_user$project$Elmodoro$PausePomo),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('button-primary'),
								_1: {ctor: '[]'}
			...
			return A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Finish Break'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				});
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Elmodoro'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _user$project$Elmodoro$viewStatus(model.status),
										_1: {
											ctor: '::',
											_0: A2(
												_elm_lang$html$Html$br,
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Current pomodoro'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
											...
											{ctor: '[]'},
											{
												...
												_1: {
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _user$project$Elmodoro$viewStats(model),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
											...
											_0: A2(
												...
												{ctor: '[]'},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('Previous pomodoros'),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
...
var _user$project$Elmodoro$Tick = function (a) {
...
var Elm = {};
Elm['Elmodoro'] = Elm['Elmodoro'] || {};
if (typeof _user$project$Elmodoro$main !== 'undefined') {
    _user$project$Elmodoro$main(Elm['Elmodoro'], 'Elmodoro', undefined);
}
